...
public class EndpointResult<TValue> : IResult, IEndpointMetadataProvider
{
    ...
    public static implicit operator EndpointResult<TValue>(Result<TValue, Error> result) => new EndpointResult<TValue>(result);

    public static implicit operator EndpointResult<TValue>(Result<TValue, Errors> result) => new EndpointResult<TValue>(result);
